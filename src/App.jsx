...
            transition={{ duration: 0.6, delay: 0.2 }}
            viewport={{ once: true }}
            className="mb-8 text-center text-3xl md:text-4xl lg:text-5xl text-gray-900 dark:text-gray-50 font-bold"
            style={{ fontFamily: 'Inter, ui-sans-serif, system-ui, sans-serif' }}
          >
...
            transition={{ duration: 0.6, delay: 0.3 }}
            viewport={{ once: true }}
            className="text-lg md:text-xl text-gray-800 dark:text-gray-200 text-center max-w-3xl mx-auto"
            style={{ fontFamily: 'Inter, ui-sans-serif, system-ui, sans-serif' }}
          >
...
        <path d="M12.04 2.22c-5.46 0-9.91 4.45-9.91 9.91 0 1.63.4 3.2.98 4.6l-1.05 3.86 3.96-1.04c1.32.76 2.82 1.16 4.43 1.16 5.46 0 9.91-4.45 9.91-9.91s-4.45-9.91-9.91-9.91zm.04 15.91c-1.28 0-2.56-.37-3.66-1.08l-.26-.16-2.73.71.72-2.65-.18-.28c-.71-1.06-1.07-2.31-1.07-3.56 0-4.4 3.59-7.99 7.99-7.99 2.14 0 4.15.86 5.66 2.37s2.37 3.52 2.37 5.66c0 4.4-3.59 7.99-7.99 7.99zm4.27-5.94c-.23-.11-.94-.47-1.08-.52-.15-.05-.26-.07-.37.07-.11.15-.43.52-.52.62-.09.11-.18.12-.32.03-.14-.09-.59-.22-1.12-.69-.42-.37-.7-1.1-.23-1.84.09-.15.2-.26.31-.41.09-.12.06-.23-.02-.37-.09-.15-.37-.9-.52-1.29-.15-.37-.3-.32-.47-.32-.17 0-.37-.03-.57-.03s-.52.07-.7.31c-.19.23-.71.71-.71 1.74 0 1.03.73 2.01.83 2.15.09.14 1.41 2.16 3.42 2.93 1.01.37 1.8.61 2.39.77.78.21 1.04.18 1.25.11.23-.08.77-.32 1.03-.64.26-.33.26-.61.18-.77-.09-.15-.35-.24-.72-.44z"/>
      </svg>
    </motion.a>
  );
};
